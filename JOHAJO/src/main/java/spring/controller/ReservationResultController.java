...
public class ReservationResultController {
	...
	@RequestMapping(value="/reservationfin.do",method=RequestMethod.GET)
	 public @ResponseBody List<NmBasketDto> resfinsh(HttpServletRequest session,@RequestParam int nsid){
		ModelAndView model =new ModelAndView();
